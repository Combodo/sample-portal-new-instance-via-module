...
/// THINGS TO CHANGE
/// - Classes name
/// - DBObject::RegisterURLMakerClass usage with module ID and class to use
///////////////////////////////////////////////////////////////////////////
 ...
 */
class ModulePortalEditUrlMaker implements iDBObjectURLMaker
{
	/**
 ...
 *
 */
class ModulePortalViewUrlMaker extends ModulePortalEditUrlMaker
{
	public static function MakeObjectURL($sClass, $iId)
	{
...
// Module portal hyperlink (for notifications) is the edit hyperlink
DBObject::RegisterURLMakerClass('sample-portal-new-instance-via-module', 'ModulePortalEditUrlMaker');
